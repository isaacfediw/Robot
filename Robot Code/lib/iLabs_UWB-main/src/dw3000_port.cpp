...
// Shim for FreeRTOS critical sections to work on RP2040
static uint32_t __save_interrupts;
#define portENTER_CRITICAL() __save_interrupts = save_and_disable_interrupts()
#define portEXIT_CRITICAL()  restore_interrupts(__save_interrupts)
#define portDISABLE_INTERRUPTS() __save_interrupts = save_and_disable_interrupts()
#define portENABLE_INTERRUPTS() restore_interrupts(__save_interrupts)
